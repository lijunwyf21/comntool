...
public class JClosableTabbedPane extends JTabbedPane implements MouseListener {
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        /*
        ImageIcon ii = (ImageIcon)getIconAt(tabNumber);
        Rectangle rect = getUI().getTabBounds(this, tabNumber);
        rect.setSize(ii.getIconWidth()+16, ii.getIconHeight());
...
// https://blog.csdn.net/ycb1689/article/details/7971954 
